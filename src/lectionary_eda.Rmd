...
It appears that there is no consistent relationship between book length (number of verses) and the percent read on major Sundays and Feasts.
...
ggplot(data = unread_df, aes(x = N_Verses, y = Perc_Read, label = Abbrv)) +
    ...
    ylab("Percent Read on Sundays and Major Feasts") +
...
## Visualize the Lectionary Coverage (Bookshelf)
